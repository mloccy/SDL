      ...
      if(SDL_X11_SHARED)
        ...
        if(X11_LIB)
          if(HAVE_X11_SHARED)
            ...
            sdl_link_dependency(x11 LIBS PkgConfig::x11 CMAKE_MODULE X11 PKG_CONFIG_SPECS ${X11_PKG_CONFIG_SPEC})
            ...
            sdl_test_link_dependency(x11 LIBS PkgConfig::x11 CMAKE_MODULE X11 PKG_CONFIG_SPECS ${X11_PKG_CONFIG_SPEC})
        ...
        if(XEXT_LIB)
          if(HAVE_X11_SHARED)
            ...
            sdl_link_dependency(xext LIBS PkgConfig::Xext CMAKE_MODULE X11 PKG_CONFIG_SPECS ${Xext_PKG_CONFIG_SPEC})
          endif()
        endif()
      else()
        sdl_link_dependency(x11 LIBS PkgConfig::x11 CMAKE_MODULE X11 PKG_CONFIG_SPECS ${X11_PKG_CONFIG_SPEC})
      ...
      if(SDL_X11_XCURSOR)
        if (HAVE_XCURSOR_H AND XCURSOR_LIB)
          ...
          if(HAVE_X11_SHARED)
            ...
            sdl_link_dependency(xcursor LIBS PkgConfig::xcursor CMAKE_MODULE X11 PKG_CONFIG_SPECS ${Xcursor_PKG_CONFIG_SPEC})
          endif()
      ...
      if(SDL_X11_XINPUT)
        if(HAVE_XINPUT2_H AND XI_LIB)
          ...
          if(HAVE_X11_SHARED)
            ...
            sdl_link_dependency(xi LIBS PkgConfig::xi CMAKE_MODULE X11 PKG_CONFIG_SPECS ${Xi_PKG_CONFIG_SPEC})
          endif()
      ...
      if(SDL_X11_XFIXES)
        if (HAVE_XFIXES_H AND HAVE_XINPUT2_H AND XFIXES_LIB)
          if(HAVE_X11_SHARED)
            ...
            sdl_link_dependency(xfixes LIBS PkgConfig::xfixes CMAKE_MODULE X11 PKG_CONFIG_SPECS ${Xfixes_PKG_CONFIG_SPEC})
          endif()
      ...
      if(SDL_X11_XRANDR)
        if(HAVE_XRANDR_H AND XRANDR_LIB)
          if(HAVE_X11_SHARED)
            ...
            sdl_link_dependency(xrandr LIBS PkgConfig::xrandr CMAKE_MODULE X11 PKG_CONFIG_SPECS ${Xrandr_PKG_CONFIG_SPEC})
          endif()
      ...
      if(SDL_X11_XSCRNSAVER)
        if(HAVE_XSS_H AND XSS_LIB)
          if(HAVE_X11_SHARED)
            ...
            sdl_link_dependency(xss LIBS PkgConfig::xscrnsaver CMAKE_MODULE X11 PKG_CONFIG_SPECS ${Xss_PKG_CONFIG_SPEC})
          endif()
      ...
      if(SDL_X11_XTEST)
        if(HAVE_XTEST_H AND XTST_LIB)
          if(HAVE_X11_SHARED)
            ...
            sdl_link_dependency(xtst LIBS PkgConfig::xtst CMAKE_MODULE X11 PKG_CONFIG_SPECS ${Xtst_PKG_CONFIG_SPEC})
          endif()
